...
from seq_scripts import seq_convert
import utils
...
class Processor():
    ...
    def start(self):
        ...
        seq_convert(vid, vid_lgt, self.model, self.device, self.arg.work_dir, self.recoder)
        self.recoder.print_log('Conversion Done.\n')
